class DataTable {
  ...
  createThead() {
    ...
    this.columns.forEach((column) => {
      ...
      $th.addEventListener("click", (e) => {
        ...
        let sortedData = this.searchedData == null || this.searchedData.length == 0 ? this.data : this.searchedData;                
  ...
  this.$tbody.innerHTML = '';
  this.createPagination();
  this.renderData(this.dataCount, this.searchedData == null || this.searchedData.length == 0 ?  this.data : this.searchedData);
})
  ...
  createSearchForm() {
    ...
    this.$search.addEventListener("input", (e) => {
      ...
      this.per = Math.ceil(this.searchedData.length == 0 ? this.data.length/this.dataCount : this.searchedData.length / this.dataCount);
      this.$tpage.remove();
      this.$tbody.innerHTML = '';    
      this.renderData(this.dataCount, this.searchedData == null || this.searchedData.length == 0 ? this.data : this.baseData);
      this.createPagination();
    });
  }
