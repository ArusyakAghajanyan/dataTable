class DataTable {
  ...
  createPageSelect() {
    ...
    $select.addEventListener("change", (e) => {
      ...
      let forRender = this.searchedData.length !== 0 ? this.searchedData.slice(start) : this.data.slice(start, end);
      // this.searchedData.length == 0 ? this.forRender : this.searchedData.length / this.dataCount;
